...
public class GetNotificationsTest extends TestBase{

    @DataProvider(name = "testData")
    public static Object[] provideTestData(final ITestContext context) {
        return provideTestData(GetNotificationsTest.class, context);
    }

    @Factory(dataProvider = "testData")
    public GetNotificationsTest(final TestData testData) {
        setTestClassObject(testData);
    }

    @Test()
    public void getNotificationsTest() throws IOException, JSONException {

...
public class GetSensorsTest extends TestBase  {

    @DataProvider(name = "testData")
    public static Object[] provideTestData(final ITestContext context) {
        return provideTestData(GetSensorsTest.class, context);
    }

    @Factory(dataProvider = "testData")
    public GetSensorsTest(final TestData testData) {
        setTestClassObject(testData);
    }

    @Test()
    public void getSensorsTest() throws IOException, JSONException {
